...
const DashboardCard = ({ item, data }) => {
  return (
    <>
      <div className="mx-auto   rounded-md my-1 px-2">
        <div className="lg:ml-2 my-2 h-32 bg-red-300 rounded-lg shadow flex flex-col justify-center items-center space-y-4 lg:h-48 hover:drop-shadow hover:shadow-zinc-600 hover:cursor-pointer">
